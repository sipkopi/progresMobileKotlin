...
class KopiAdapter(val dataMorty: List<ResultsItem?>?) : RecyclerView.Adapter<KopiAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_row_kopi,parent,false)
